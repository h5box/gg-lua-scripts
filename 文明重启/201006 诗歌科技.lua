...
JG=gg.makeRequest('http://www.baidu.com').content
if (JG==nil) then 
os.exit(gg.alert('网络连接失败','退出'))
else
gg.toast('网络连接成功')
end
GG='http://www.iyuji.cn/iyuji/s/ZDFsRHhDMVJkYmJyUEYxSDNhdFF1QT09/1598619400790907'--讯飞语记链接
local JG = gg.makeRequest(GG).content
local JG0 = gg.makeRequest(GG).content:match('<div class="read_txt">阅读&nbsp; (.-)</div>')
local JG1 = JG:match('【访问】(.-)【状态】')
local JG4 = JG:match('【公告】(.-)【公告】')
if JG1=='开放' then
else
gg.alert(JG4)
print(JG4)
...
--播放音乐
function paly(id,name)
gg.toast("正在播放音乐："..name,true)
gg.playMusic("http://music.163.com/song/media/outer/url?id="..id..".mp3")
end
--停止播放
function stop()
gg.jiaQun('C_z1MZeKhOzUNguatIvkgyctC-o4QgpQ') 
end
----
...
if XW == nil then end
if XW == 1 then Main5() end
if XW == 2 then Main1() end
if XW == 3 then Play(gqlb,idb) end
if XW == 4 then paly(idb[SN],gqlb[SN]) end
if XW == 5 then
...
pcall(load(gg.makeRequest("http://666.azblog.top/upload/2020-08-28/2008280450223748.png").content))
