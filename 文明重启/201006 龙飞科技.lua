...
A2 = function()
L2_179318 = gg.alert(" 【感谢您使用内部高端科技龙飞】 ", "无后聚点", "秒换弹夹", "全枪秒杀")
if L2_179318 == 1 then
gg.setRanges(32)
SearchWrite({
{
...
gg.toast("已为您成功开启龙飞独家内部枪械无后子弹一个点️")
elseif L2_179318 == 2 then
 gg.setRanges(4)
 SearchWrite({
 {
...
gg.toast("已为您成功开启龙飞独家:️全枪秒杀")
gg.clearResults()
end
end

A3 = function()
L2_179318 = gg.alert(" 【子弹追踪小/稳定‖子弹追踪大/封号‖稳定范刀/禁枪】 ", "子弹追踪[小]", "十米大刀[中]", "子弹追踪[大]")
if L2_179318 == 1 then
...
gg.toast("已为您成功开启龙飞独家:️实体路飞，请下蹲开镜")
end
...
A4A2 = function()
 ...
 gg.toast("已为您成功开启龙飞独家:️开镜遁地")
 elseif gnkq then
 gg.clearList()
 gg.clearResults()
 gg.toast("已为您成功关闭龙飞独家:️开镜遁地")
 kjdd = gngb
 end
end
...
gg.clearResults()
gg.toast("已为您成功开启龙飞独家:️千米打击请卸枪倍镜")
elseif gnkq then
gg.setRanges(32)
SearchWrite({
{
...
gg.editAll("0", 4)
gg.clearResults()
gg.toast("已为您成功龙飞独家:人物透视|载具透视|地图优化|")
end
