...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    "➥  人物强化 ☤  ",
    "➥  退出科技 ☤  ",	             
},nil,"投稿加QQ:3327597633"..os.date("时间为:%m月%d日 %H:%M"))  
    if MF == 1 then  A () end
    if MF == 2 then  B () end
    if MF == 3 then  C () end    
...
function A5()
   F = gg.alert("【仁義持续为您护航】", "⟬开镜路飞⟭","⟬开镜遁地⟭","⟬秒开倍镜⟭")
    if F == 1 then
    gg.clearList()
    gg.clearResults()
...
function A6()
F = gg.alert("【仁義持续为您护航】", "⟬水下开车⟭"..DXY,"⟬水下行走⟭"..XXX,"⟬橡皮路飞⟭"..SSS)
 if F == 1 then
XXI()
elseif F == 2 then  
XXI2()
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
function B1()
  F = gg.alert("⟬仁義持续为您护航⟭", "⟬联发荧黑⟭","⟬骁龙荧蓝⟭","⟬麒麟荧白⟭")
    if F == 1 then
  gg.clearList()
  gg.clearResults()
  gg.setRanges(131072)
...
function C2()
   F = gg.alert("【仁義持续为您护航】", "⟬蓝色天线⟭"..LTX,"⟬原色天线⟭"..TX)
    if F == 1 then
    LSTX()
    elseif F == 2 then  
    YSTX()
...
function C10()
      F = gg.alert("【仁義持续为您护航】", "⟬穿墙方法⟭","⟬实体穿墙⟭","⟬穿墙防死⟭"..STT)
      if F == 1 then
