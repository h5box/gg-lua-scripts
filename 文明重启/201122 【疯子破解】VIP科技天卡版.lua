...
function d5()
  gg.toast("请将冻结间隔设置为0")
  gg.setRanges(4)
  SearchWrite({{-1.0E32, 0},{1.03999996185, -24},{0, 4}}, {{0.345,-8,true}}, gg.TYPE_FLOAT, "蓝鲸水上行走第一步")
  SearchWrite({{-1.0E32, 0},{1.04000091553, -24},{0, 4}}, {{0.345,-8,true}}, gg.TYPE_FLOAT, "蓝鲸水上行走第二步")
  gg.toast("水上行走开启成功")
end
...
function h3()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber('1.70000004768', 16, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber('1.70000004768', 16, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(100)
gg.editAll('5',16)
gg.toast('第五人称已开启')
...
function h12()
  QL()
  NC(ANONYMOUS) 
	 CZ("31.1111125946",FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  CZ("31.1111125946",FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 jg=FW(100)
	 sl=FWW()
	 if sl>100 then sl=100 end
	 for i = 1, sl do
	 	 dzy=jg[i].address
	 	 gg.addListItems({[1] = {address = dzy,flags = FLOAT,freeze = true,value = 3}})
	 end
  TS("十字镜八倍开启成功")
	 QL()
 end
...
function Exit()
  print("    ️破解者：疯子  QQ：2169849306  稳不稳您说了算    ️")
  os.exit()
end
function HOME()
  lw=1
