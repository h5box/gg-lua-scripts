...
if gg.BUILD < 15386 then
	gg.alert('您正在使用旧版本的游戏监护人。有些功能可能不起作用,或者工作效果不如预期。')
end
...
while true do
	g.info = gg.prompt({'选择脚本/汇编文件:', '-选择输出的可写路径:',
		'使用GG的版本:', '日志调用“load”的最的大小[可过滤垃圾]'}, g.info, {'file', 'path', 'text', 'number'})
