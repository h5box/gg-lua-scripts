asd = gg.alert('欢迎使用伤感神内部免费脚本，4.6更新内容:增加传送功能，增加恐龙功能，增加角色功能，增加连发功能，增加一键美化，增加火力功能，增加一键稳定功能，增加跳高改追捕无敌buff，增加逃生刷钱，增加逃生视野扩大，增加逃生开锁范围，增加雇佣兵无限夹子，增加追捕视野扩大，增加追捕刷钱，优化防闪，优化防封','进入脚本','退出脚本')
if asd == 2 then os.exit(print("💎已退出💎")) end
...
"🍺传送功能🍺",
"👿退出脚本👿",
}, nil, os.date("本脚本为伤感神所写，总共204个功能，禁止二改倒卖，如有发现二改倒卖，开户处理，QQ1254166911，交流群:607528507"))
...
"🥺防乱斗（作者专用）🥺",
"😡返回界面😡",
}, nil, os.date("最近逃跑检测很强，所以这些功能建议开"))
if menu1 == nil then else
...
"😎逃脱八人(大厅)😎",
"😱返回界面😱",
}, nil, os.date("8.14.1秒赢，该秒赢为手动秒赢，先在大厅开启击倒50人、个人伤害、救人数量、逃脱八人，然后进入局内等待32秒，然后再打开倒地结算即可赢，很稳定"))
if menu1 == nil then else
...
"❤️道具卡修改品质（大厅）❤️",
"💔返回界面💔",
}, nil, os.date("8.14.1可以用，美化功能实战别人看不到，大乱斗有自建房别人才能看到，局内开启"))
if menu1 == nil then else
...
"🦖霸王龙全屏攻击+秒杀(局内)🦖",
"🦕返回界面🦕",
}, nil, os.date("8.14.1版本能用，霸王龙开启教程:先开启皮卡实体改霸王龙（大厅开启），然后变成霸王龙打一下，然后再开霸王龙全屏秒杀就可以速刷了"))
if menu1 == nil then else
