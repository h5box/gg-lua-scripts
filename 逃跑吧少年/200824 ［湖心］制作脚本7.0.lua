...
function HS162()
	 gg.alert("hello，大家好，我是湖心，相信大家都知道啥是封号吧，那么如果防封呢？请点封号机制2")
end

function HS163()
gg.alert("我们来将一下封号机制，那就是只要你一个号一直开挂也是会封号的，这里你是可以开稳定防封和拦截，并且还得演，不过就算是演，只要遇到个行家也是会被发现的，所以你们可以尝试一下开一局退一局，清理数据，这样估计会比之前稳定一点，要是你还是觉得不稳定，你可以试试一天就开一局，这样估计封号率就会降到很低，好了就先到这里吧，等有了新的发现再加上去。")
end
