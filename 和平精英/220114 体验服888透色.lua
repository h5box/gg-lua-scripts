...
if menu[1] == true then AA1() end 
if menu[2] == true then AB1() end 
if menu[3] == true then A1() end 
if menu[4] == true then A2() end 
if menu[5] == true then A3() end 
if menu[6] == true then A4() end 
if menu[7] == true then A5() end 
if menu[8] == true then A6() end 
if menu[9] == true then A7() end 
if menu[10] == true then A8() end 
if menu[11] == true then A9() end 
if menu[12] == true then A10() end 
if menu[13] == true then A11() end
if menu[14] == true then A12() end
if menu[15] == true then Exit()   end
end XGCK = -1 end
function AA1()
	 gg.clearResults()
	 gg.setRanges(1048576)
	 gg.searchNumber("8,192;8,204;8,196;8,200;196,609::73", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
	 ...
	 gg.clearResults()
	 gg.setRanges(1048576)
	 gg.searchNumber("7.23032914e-15F;2.37548875809F;3.53508353e-29F;2.25000047684F;2F;1.66230384e-19F::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 ...
	 gg.clearResults()
	 gg.setRanges(1048576)
	 gg.searchNumber("2.0F;-1.0F;0.0F;1.0F;-127.0F;0.24022650719F;0.69314718246F;0.00999999978F;-0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;0.0F;317,448.03125F;3.36311631e-44F;::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 gg.editAll("120", gg.TYPE_FLOAT)
	 gg.toast("透视成功")
	 gg.clearResults()
	 gg.searchNumber("0.00001001358F;2.0F;-0.01000213623F;-1.0F", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 ...
	 gg.clearResults()
	 gg.setRanges(1048576)
	 gg.searchNumber("7.23033592e-15F;2.37549066544F;3.53508594e-29F;2.25000238419F;2.0F", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 gg.editAll("120", gg.TYPE_FLOAT)
	 gg.toast("房区防闪开启成功")
