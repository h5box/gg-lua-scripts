...
"美化功能--[A-全局]",
"退出旅途--[A-再见]"},
2020,'灾难内部交流群:467067092    国服全防开两次')       
if DTL == 1 then A0() end
if DTL == 2 then A1() end
if DTL == 3 then A2() end
if DTL == 4 then A3() end
if DTL == 5 then A4() end
if DTL == 6 then A5() end
if DTL == 7 then A6() end
if DTL == 8 then A7() end
if DTL == 9 then Exit() end
XGCK=-1
end 
...
{["memory"] = 32},
{["name"] = "结算过检部署➤%100"},
{["value"] = 1954047316, ["type"] = 4},
{["lv"] = 1970037078, ["offset"] = 4, ["type"] = 4},
{["lv"] = 1633906508, ["offset"] = 32, ["type"] = 4},
{["lv"] = 7562578, ["offset"] = 40, ["type"] = 4},
}
qmxg = {
...
qmxg = {
{["value"] = 1633906508, ["offset"] = 32, ["type"] = 4},
}
xqmnb(qmnb) 
end
...
{["lv"] = 16384, ["offset"] = 20, ["type"] = 4},
{["lv"] = 5120, ["offset"] = 100, ["type"] = 4},
{["lv"] = 16384, ["offset"] = 508, ["type"] = 4},
}
qmxg = {
{["value"] = 75776, ["offset"] = 0, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 4, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 8, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 12, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 16, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 20, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 100, ["type"] = 4,["freeze"]=true},
{["value"] = 75776, ["offset"] = 508, ["type"] = 4,["freeze"]=true},
}
xqmnb(qmnb)
...
"飞天--[D-单局]",
"菜单--[D-返回]"},
nil,'灾难内部交流群:467067092    国服全防开两次')
if DTL3 == nil then else
if DTL3[1] == true then d1() end
if DTL3[2] == true then d2() end
if DTL3[3] == true then d3() end
if DTL3[4] == true then d4() end
if DTL3[5] == true then d5() end
if DTL3[6] == true then d6() end
if DTL3[7] == true then d7() end
if DTL3[8] == true then d8() end
if DTL3[9] == true then d9() end
if DTL3[10] == true then d10() end
if DTL3[11] == true then DongTianLeng() end
end
GLWW=-1
end
...
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("1;0.5;3000;5000;-99999::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("1.137;0.0001;20;0.0005;0.4::50", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("1.137", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(500)
gg.editAll("1", gg.TYPE_FLOAT)
gg.toast("微速关闭➤%100")
end
...
gg.searchNumber("1", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(500)
gg.editAll("1.137", gg.TYPE_FLOAT)
gg.clearResults()
gg.setRanges(gg.REGION_C_DATA)
...
qmxg = {
{["value"] = 190, ["offset"] = 24, ["type"] = 16},
{["value"] = 190, ["offset"] = 28, ["type"] = 16},
{["value"] = 190, ["offset"] = 32, ["type"] = 16},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = gg.REGION_ANONYMOUS},
...
if DTL2[6]==true then DongTianLeng() end
end
GLWW=-1
end 
...
'主页菜单--[E-返回]'},
nil,'灾难内部交流群:467067092    国服全防开两次')
if DTL4 == nil then else
if DTL4[1] == true then e1() end
if DTL4[2] == true then e2() end
if DTL4[3] == true then e3() end
if DTL4[4] == true then DongTianLeng() end
end
GLWW=-1
end
...
nil,'灾难内部交流群:467067092    国服全防开两次') 
if DTL2 == nil then else    
if DTL2[1]==true then f1() end
if DTL2[2]==true then f2() end
if DTL2[3]==true then f3() end
if DTL2[4]==true then DongTianLeng() end
end
GLWW=-1
end
...
{["lv"] = 5, ["offset"] = 44, ["type"] = 4},
{["lv"] = 501001, ["offset"] = 48, ["type"] = 4},
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 501001046, ["offset"] = 48, ["type"] = 4},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = 32},
...
{["lv"] = 1, ["offset"] = 4, ["type"] = 4},
{["lv"] = 5, ["offset"] = 44, ["type"] = 4},
{["lv"] = 501002, ["offset"] = 48, ["type"] = 4},
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 501002046, ["offset"] = 48, ["type"] = 4},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = 32},
...
{["lv"] = 1, ["offset"] = 4, ["type"] = 4},
{["lv"] = 5, ["offset"] = 44, ["type"] = 4},
{["lv"] = 501003, ["offset"] = 48, ["type"] = 4},
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 501003046, ["offset"] = 48, ["type"] = 4},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = 32},
...
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 502001, ["offset"] = 96, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 502001034, ["offset"] = 96, ["type"] = 4},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = 32},
...
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 502002, ["offset"] = 96, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 502002034, ["offset"] = 96, ["type"] = 4},
}
xqmnb(qmnb)
qmnb = {
{["memory"] = 32},
...
{["lv"] = 257, ["offset"] = 52, ["type"] = 4},
{["lv"] = 5, ["offset"] = 92, ["type"] = 4},
{["lv"] = 502003, ["offset"] = 96, ["type"] = 4},
{["lv"] = 257, ["offset"] = 100, ["type"] = 4},
}
qmxg = {
{["value"] = 502003034, ["offset"] = 96, ["type"] = 4},
}
xqmnb(qmnb)
end
...
gg.searchNumber("330600100", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(100)
gg.editAll("330600900", gg.TYPE_DWORD)
gg.toast("特斯拉美化➤%100")
end
...
---DongTianLeng出品必是精品---
function Exit()
local DTL5 = gg.alert("确定退出脚本？\n您将只能退出游戏来关闭功能。","确认退出","使用帮助","获取基佬总群QQ")
if DTL5 == nil then DongTianLeng() end
if DTL5 == 1 then
gg.clearResults()
gg.toast("已退出脚本")
print("🌟灾难防封，感谢使用🌟")
...
if DTL5 == 2 then
gg.alert("🔰若有什么好意见可以加群🔰")
end
if DTL5 == 3 then
gg.copyText("467067092")
end
end
