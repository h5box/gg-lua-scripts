...
"秒断网",
'退出脚本'},
2018,'欢迎加入缩神交流群1031473318，修复了665透视，新增665变色上色')
...
if menu1[9] == true then bss() end
if menu1[10] == true then a9() end
if menu1[11] == true then a10() end
if menu1[12] == true then atx() end
if menu1[13] == true then a11() end
if menu1[14] == true then a12() end
if menu1[15] == true then a13() end
...
if menu1[8] == true then d13() end
if menu1[9] == true then d8() end
if menu1[10] == true then d9() end
if menu1[11] == true then d10() end
if menu1[12] == true then d11() end
if menu1[13] == true then d12() end
...
function d13()
 gg.clearResults()
	 gg.setRanges(131072)
	 gg.searchNumber("1.5414283e-44;1.1204994e-19;4.7644148e-44;1.662336e-19;0.0;3.7615819e-37;2.0;-1.0;1.0;0.69314718246;0.00999999978;0.0;0.0:177", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 gg.editAll("120", gg.TYPE_FLOAT)
	 gg.toast("855物资透视开启成功")
	 gg.clearResults()
...
function bss()
	 gg.clearResults()
	 gg.setRanges(131072)
	 gg.searchNumber("256;35,651,601;-1,598,023,920;524,296;1,080,037,392;5:21", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("-1,598,023,920", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 gg.editAll("-521", gg.TYPE_DWORD)
	 gg.toast("缩神牛逼")
	 gg.clearResults()
end
...
gg.clearResults()
	 gg.setRanges(131072)
	 gg.searchNumber("8200;8201;8202;8203", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
