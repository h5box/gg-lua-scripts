...
'🥝防封区️',
'退出脚本'},
nil,'按照要求开启，冷颜反馈群1090896116，别的群都是冒充')
...
"防止禁网",
'点击确定返回上一页'},
nil,'防封防禁网必须在大厅执行，执行过程中请勿切屏或点击修改器，以免数据错乱造成封号问题')
if menu1 == nil then else
...
function d1()
lynb =gg.alert('开启此功能后会导致联发科透视异常闪烁，是否开启?\n\n','确定开启','取消开启')
if lynb == 1 then 
gg.toast("请稍后……")
end
if lynb == 2 then 
...
function d2()
gg.clearResults()
 gg.setRanges(32) gg.searchNumber('1.5584387e28', 16, false, gg.SIGN_EQUAL, 0, -1) gg.searchNumber('1.5584387e28', 16, false, gg.SIGN_EQUAL, 0, -1) gg.getResults(100) gg.editAll('0', 16) gg.toast('防追封开启成功')
