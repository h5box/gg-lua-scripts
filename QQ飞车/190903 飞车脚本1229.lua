 ...
 gg.toast('魅影QQ群314395407')
print('魅影QQ群314395407') 
...
gg.clearResults()
gg.alert("by: 禁止倒卖，倒卖死全家，魅影QQ群314395407更新");
goto START


::START::
menu = gg.choice({'无限气','引擎加速','全局加速（10倍）','全局加速（50倍）','所有功能请在匹配成功后开启','全局加速不能匹配所有，通剧情用','by:诺尘 禁止倒卖，倒卖死全家，魅影QQ群314395407'},nil,'魅影QQ群314395407')
