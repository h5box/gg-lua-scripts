...
function a()
Fxs({{2.96700000763,0,16},
{119,-4,4},
{0,4,4},
{0,8,4},
{0,12,4},},
{{100000.123,0,16},},32,"温蒂")
...
function b()
Fxs({{0.55199998617,0,16},},
{{800.123,0,16},},32,"芭芭拉")
end

function c()
Fxs({{2.30399990082,0,16},},
{{800.123,0,16},},32,"凝光",false)
end
...
Fxs({{3,0,16},
{2,48,16},},
{{52,0,16},{52,48,16},},32,"拾取范围",false)
end


function g()
Fxs({{1.87000000477,0,16},
{0.12999999523,-112,16},
{0.12999999523,-108,16},
{-0.92000001669,-104,16},
{-0.92000001669,-100,16},
{-1.87000000477,-96,16},
{-1.87000000477,-92,16},
{-1,-88,16},
{-1,-84,16},
...
{1,332,16},
{1,884,16},},
{{0.35,332,16},{0.15,884,16},},4,"加速",false)
end


function h()
Fxs({{1.12000000477,0,16},
{119,-4,4},
{0,4,4},
{0,8,4},
{0,12,4},},
{{100000.123,0,16},},32,"技能2秒杀",false)

Fxs({{1.1128000021,0,16},
{119,-4,4},
{0,4,4},
{0,8,4},
{0,12,4},},
{{100000.123,0,16},},32,"技能1秒杀",false)

Fxs({{10232,0,4},
{12,96,16},},
{{0,96,16},},32,"香菱无cd",false)
end
...
{0,8,16},
{60,28,16},},
{{0,-12,16},{0,164,16},},32,"近战无cd",false)
...
{0,8,16},
{40,28,16},},
{{0,-12,16},{0,164,16},},32,"射手无cd",false)
...
{0,8,16},
{80,28,16},},
{{0,-12,16},{0,164,16},},32,"法师无cd",false)
end
