...
'100-锁血量',
'退出脚本',
}, nil, os.date "真神仙提示--必须按提示金币的时候开启")
...
{["name"] = "修改金币"},
{["value"] = 100, ["type"] = 4},
{["lv"] = 256, ["offset"] = -192, ["type"] = 4},
{["lv"] = 10, ["offset"] = 120, ["type"] = 4},
}
qmxg = {
{["value"] = 500, ["offset"] = 120, ["type"] = 4, ["freeze"] = true},
}
xqmnb(qmnb)
end
...
qmxg = {
{["value"] = 100, ["offset"] = 4, ["type"] = 4, ["freeze"] = true},
}
xqmnb(qmnb)
end

function Exit()
print("科技岛：www.kjdao.net")
os.exit()
end
function HOME()
lw=1
