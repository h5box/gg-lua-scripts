if FX2 == nil then
  mm = gg.prompt({[1]="欢迎使用雪冷水制作的脚本，QQ交流群群号:903035367，输入“0”进入脚本，其他数字退出。"}, {[1]="0"}, {[1]="txet"})
  if mm[1] == "0" then
    gg.toast("正在进入，请稍后。")
  else
    print(mm[1],"退出成功。")
...
SN = gg.choice({
	 ...
	 "坐骑区（联机不可用)",
	 "其他功能区（联机不可用)",
}, nil, "作者迷你号:566567219，更多脚本请加QQ交流群，群号:903035367。")
if SN==1 then
	 Main5()
end
if SN==2 then
...
function HS30()
	 gg.clearResults()
gg.searchNumber("64000;16777472;1065353216;1F;1065353216;1F;1065353216;1F", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
