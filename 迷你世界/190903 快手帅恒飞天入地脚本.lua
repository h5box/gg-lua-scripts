...
::START::
menu = gg.choice({'熊商店专用','单人专用'},nil,'♝⭐禁止转发⭐♝')
...
::START1::
menu = gg.choice({'①穿墙','②无限跳（63高度专用自己冻结）','③无限跳（高度8的时候用这个）','返回'},nil,'♝快手代桃666♝')
...
gg.getResults(50)
gg.editAll('0', gg.TYPE_DWORD)
gg.toast('代桃能量剑无限技能开启')
goto sdone

::sdone:: 
print('快手代桃')
print('QQ号2716009712')
gg.toast('行不行，快手搜代桃，群820530990快进群我会发很多教程的！')
