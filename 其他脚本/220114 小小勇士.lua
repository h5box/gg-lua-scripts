...
{0.5,-24,64},
{0.5,-12,64},},
{{10,-12,64},},32,"Fxs",false)

Fxs({{1.5,0,64},
{2,36,64},
{0.03,84,64},
{0.1,96,64},},
{{10,0,64},{10,36,64},},32,"Fxs",false)
end
...
{0.00100000005,-8,16},
{9000,-4,16},},
{{0.0001,-12,16},},32,"恢复穿墙",false)
end


function e()
Fxs({{0.28999999166,0,16},},
{{99,0,16},},16384,"无视普攻",false)
end
...
{0.00999999978,8,16},
{100,20,16},},
{{0.30000001192,0,16},},16384,"恢复定怪",false)
end


function gjdnx()
Fxs({{2.3122343e-35,0,16},
{10,-28,16},},
{{9999,-28,16},},32,"互秒2",false)
end
