...
function Main()
  ...
  "属性秒杀(上面秒杀无效果开)",
  "退出脚本"
 }, nil, "功能开好就不要点悬浮窗,闪退是正常现象，从新上游戏即可")
  if SN == nil then
  else
  if SN[1] == true then
    a()
...
gg.setRanges(32)
gg.searchNumber("1", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("1", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1000)
gg.toast("过")
function a()
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("0.45;0.17", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("0.45", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1000)
gg.editAll("10", 64)
gg.toast("效果只有第一下普攻")
end
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("2;2F;0.3;5;0.5", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("0.5", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1000)
gg.editAll("5", 64)
gg.toast("加伤")
end
...
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("10;0.17", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("10", 64, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1000)
gg.editAll("0.45", 64)
gg.clearList()
end
...
{0,4,4},
{0,12,4},},
{{-1,-12,16,true},{-1,-8,16,true},},32,"Fxs")
end

function f()
gg.clearResults()
gg.setRanges(32)
gg.searchNumber("4D;20~30F;4D::40", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("22~26", 16, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(100)
gg.editAll("18", 16)
gg.toast("第一步")
end
