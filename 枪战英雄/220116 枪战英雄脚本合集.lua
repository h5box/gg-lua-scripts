  ...
  function DZSH()
    ...
    if menu == nil then
      ...
      if menu[38] == true then
        HZ38()
      end
      if menu[39] == true then
        HZ39()
      end
      if menu[40] == true then
        HZ40()
      end
      if menu[41] == true then
        HZ41()
      end
      if menu[42] == true then
        HZ42()
      end
      if menu[43] == true then
        HZ43()
      end
      if menu[44] == true then
        HZ2()
      end
      if menu[45] == true then
        Exit()
      end
    end
    PD1 = 1
...
gg.toast("透视成功")
  ...
  function HZ11()
    gg.clearResults()
    gg.setRanges(32)
    gg.searchNumber('14;12::5', gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
    if gg.getResultCount() == 0 then
      gg.toast('开启失败')
    else
  ...
  gg.clearResults()
	 gg.setRanges(32)
	 gg.searchNumber("0.03999999911;0;2::9", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.searchNumber("0.03999999911", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(100)
	 gg.editAll("10.31745454", gg.TYPE_FLOAT)
	 gg.toast("❤完美飞天🍀")
	 gg.clearResults()
  end
  function HZ18()
   gg.clearResults()
	 gg.setRanges(32)
	 gg.searchNumber("10.31745454", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
	 gg.getResults(1)
  ...
  function H2()
    ...
    gg.searchNumber(gg.prompt({
      ...
      [1] = 'number'
    })[1], gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  ...
  function HZ39()
    ...
    gg.toast('退出战斗，记的关闭哟，小心卡视角')
    gg.clearResults()
  end
  function HZ40()
    gg.clearResults()
    gg.setRanges(4)
    gg.searchNumber('0.0001;0.0001', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
    gg.searchNumber('0.0001', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
    gg.getResults(100)
    gg.editAll('-0.5', gg.TYPE_FLOAT)
    gg.toast('蹲下穿墙，卡了后果自负！')
    gg.clearResults()
  end
  function HZ41()
    gg.clearResults()
    gg.setRanges(32)
    gg.searchNumber('1.7;-40', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
