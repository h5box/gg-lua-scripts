...
{-2,288,16},},
{{300000,3424,4,true},},4,"自瞄",false)
end

function c()
Fxs({{1.1115000248,0,16},
{0.30000001192,16,16},
{0.30000001192,20,16},},
{{1.6,0,16},},32,"持刀加速",false)
end

function d()
Fxs({{0.09000000358,0,16},
{0,-20,4},
{0,-8,16},
{0.00999999978,-4,16},
{0.5,4,16},
{0,8,16},},
{{5.5,0,16},},32,"范围",false)

Fxs({{0.1439999938,0,16},
{0.00999999978,-4,16},
{0.31999999285,4,16},},
{{5.5,0,16},},32,"范围",false)
end
...
Fxs({{56.0000038147,0,16},
{56.0000038147,64,16},},
{{0,76,16},{0,212,16},},8,"全枪无后",false)
end
